    ...
    <div className="min-h-screen bg-white py-16 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none animate-slide-up">
          ...
          <h2 className="text-2xl font-bold text-dark mt-8 mb-4">¿Qué son las Cookies?</h2>
          <p className="text-gray-700 leading-relaxed mb-6">
          ...
          <h2 className="text-2xl font-bold text-dark mt-8 mb-4">Tipos de Cookies que Utilizamos</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            <strong>Cookies Esenciales:</strong> Necesarias para el funcionamiento básico del sitio web.
          </p>
          <p className="text-gray-700 leading-relaxed mb-6">
            <strong>Cookies de Funcionalidad:</strong> Permiten recordar sus preferencias, como el idioma seleccionado.
          </p>
          
          <h2 className="text-2xl font-bold text-dark mt-8 mb-4">Gestión de Cookies</h2>
          <p className="text-gray-700 leading-relaxed mb-6">
          ...
          <h2 className="text-2xl font-bold text-dark mt-8 mb-4">Más Información</h2>
          <p className="text-gray-700 leading-relaxed mb-6">
            Si tiene preguntas sobre nuestra política de cookies, contáctenos en info@tibismarket.com o al +1 (305) 123-4567.
          </p>
