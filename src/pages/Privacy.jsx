    ...
    <div className="min-h-screen bg-white py-16 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none animate-slide-up">
          ...
          <h2 className="text-2xl font-bold text-dark mt-8 mb-4">Información que Recopilamos</h2>
          <p className="text-gray-700 leading-relaxed mb-6">
          ...
          <h2 className="text-2xl font-bold text-dark mt-8 mb-4">Uso de la Información</h2>
          <p className="text-gray-700 leading-relaxed mb-6">
          ...
          <h2 className="text-2xl font-bold text-dark mt-8 mb-4">Seguridad de los Datos</h2>
          <p className="text-gray-700 leading-relaxed mb-6">
          ...
          <h2 className="text-2xl font-bold text-dark mt-8 mb-4">Sus Derechos</h2>
          <p className="text-gray-700 leading-relaxed mb-6">
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            Si tiene preguntas sobre esta política de privacidad, puede contactarnos en info@tibismarket.com o al +1 (305) 123-4567.
          </p>
