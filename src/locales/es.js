export const es = {
  ...
  home: {
    ...
    section1: {
      ...
      text: "Yo soy Tibisay Gómez. Nací en Mucuchachi (Venezuela) en 1942, cuando el viento de la sierra aún traía ecos de la guerra lejana y mi madre me arropaba con cuentos de niebla y trigo. Este pueblo, fundado en 1770 por David de la Peña en tierras que antes fueron de los timotes y los mucuchíes, es mi raíz, mi sangre, mi harina.",
    },
    section2: {
  ...
  footer: {
    ...
    aboutText:
      "Arepas artesanales desde 1942, elaboradas con amor y tradición familiar.",
